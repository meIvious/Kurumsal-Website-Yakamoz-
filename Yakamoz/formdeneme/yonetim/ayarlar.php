...
<title>Yakamoz | Admin Panel</title>
</head>
<style>
...
<body>
  ...
  <div class="col-md-2  border-right">
	...
	<div class="col-md-12 p-3 pl-3 border-top" id="btnyonetim2">
		 <a href="#"> <i class="fas fa-home" style="color:#black"></i>  Anasayfa</a>
		</div>

		<div class="col-md-12 p-3 pl-3 border-top" id="btnyonetim2">
		 <a href="ayarlar.php?islem=adminyonetimi"> <i class="fas fa-wrench" style="color:#2E7D32"></i>  Yönetici Bilgileri</a>
		</div>

		 <div class="col-md-12 p-3 pl-3 border-top" id="btnyonetim2">
		 <a href="ayarlar.php?islem=kulyonetimi"> <i class="fas fa-users" style="color:#2E7D32"></i>  İletişim Bilgileri</a>
		</div>
		<div class="col-md-12  p-3 pl-3 border-top "id="btnyonetim2">
...
/////////////////////////////ODA YÖNETİMİ//////////////////////
case "adminyonetimi":
	$yonetimclas->adminyonetimi($vt);
	break;

	case "adminekle":
		$yonetimclas->adminekle($vt);
		break;

		case "adminsil":
			$yonetimclas->adminsil($vt);
			break;
case "kulbilgi":
	$yonetimclas->kulbilgi($vt);
	break;
	  case "kulyonetimi":
