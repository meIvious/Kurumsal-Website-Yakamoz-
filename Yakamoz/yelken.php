...
<head>
  ...
  <meta charset="utf-8">
  <title>Yelken Kulübü-KARABİGA YAKAMOZ HOTEL</title>
  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">Yelken Kulübü</a></h1>
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="img/intro-carousel/yelken.jpg" alt=""></div>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="img/intro-carousel/yelken2.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="img/intro-carousel/yelken3.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
  ...
  <section id="about">
    <div class="container">
      ...
      <header class="section-header">
        <h3>KARABİGA YELKEN KULÜBÜ</h3>
        <p>İÇDAŞ A.Ş'in öngörüsüyle ve sponsorluğunda Karabiga Belediyesi'nin de katkılarıyla rüzgar ve parkur olarak Türkiye'nin en iyi yerlerinden biri olan Karabiga'da Kaleler mevkiinde deniz kıyısında kurulan Karabiga İçdaş Yelken Okulu, üç ay gibi kısa bir hazırlık sürecinden sonra 21 Haziran 2004'de faaliyete geçmiştir. 15 Temmuz 2004 tarihinde ise resmi açılış töreni düzenlenmiştir.

          21 Haziran - 15 Eylül tarihleri arasında 7-15 yaş arası (yüzme bilen) 80 öğrenciye ücretsiz kurs verilmektedir.</p>
      </header>
    </section>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-newsletter">
            <h4>Anlık Ziyaretçi Sayısı</h4>
            <script id="_wauq0y">var _wau = _wau || []; _wau.push(["dynamic", "jlrtfqazgc", "q0y", "1e90ff434343", "big"]);</script><script async src="//waust.at/d.js"></script>
            </button>
    ...
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="">Berkay KURU</a>
      </div>
    </div>
  </footer><!-- #footer -->
