...
<head>
  ...
  <meta charset="utf-8">
  <title>Plajlar-KARABİGA YAKAMOZ HOTEL</title>
  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">Plajlar</a></h1>
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="img/intro-carousel/plaj2.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="img/intro-carousel/plaj3.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
  ...
  <section id="about">
    <div class="container">
      ...
      <header class="section-header">
        <h3>KADINLAR HAMAMI PLAJI</h3>
        <p>Kadınlar Hamamı Plajı, Karabiga'nın merkezinde bulunmaktadır. Yeni yapılan yürüyüş yolları, yeşil alanlar, çocuk parkı, plaj ve çevre düzenlemeleriyle ege sahillerini aratmayacak konuma gelen plajımız, ziyaretçilerinin hoşça vakit geçirmesini sağlayacak birçok işletmeyi de barındırmaktadır.</p>
      </header>
    </section>
