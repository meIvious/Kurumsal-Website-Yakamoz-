...
<head>
  ...
  <meta charset="utf-8">
  <title>Serbest Dalış-KARABİGA YAKAMOZ HOTEL</title>
  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">Serbest Dalış</a></h1>
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="img/intro-carousel/dalis.jpg" alt=""></div>
  ...
  <section id="about">
    <div class="container">
      ...
      <header class="section-header">
        <h3>KARABİGA'DA SERBEST DALIŞ</h3>
        <p>Karabiga'da, sahilde ve koylarda serbest dalışlar yapılabilmektedir. Bu açıdan sahil ve koylarımız oldukça verimlidir.</p>
      </header>
    </section>
